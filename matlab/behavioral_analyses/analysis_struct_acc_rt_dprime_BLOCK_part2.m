...
for block = 1:7
    ...
    outfname = sprintf('Struct_acc_rt_dprime_Part2_BLOCK_%d', block);
    ...
    for c = 1:length(struct_pt2_matload_all) %REMEMBER, induct paths have participants who've completed whole complete roster
    ...
    save(sprintf('Struct_acc_rt_dprime_Part2_BLOCK_%d', block),'struct_acc_rt_dprime_ALL');
