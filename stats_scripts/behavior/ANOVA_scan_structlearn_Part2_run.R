...
struct_acc_rt_block1 <- read.delim("Struct_acc_rt_dprime_Part2_BLOCK_1.txt")
struct_acc_rt_block2 <- read.delim("Struct_acc_rt_dprime_Part2_BLOCK_2.txt")
struct_acc_rt_block3 <- read.delim("Struct_acc_rt_dprime_Part2_BLOCK_3.txt")
struct_acc_rt_block4 <- read.delim("Struct_acc_rt_dprime_Part2_BLOCK_4.txt")
struct_acc_rt_block5 <- read.delim("Struct_acc_rt_dprime_Part2_BLOCK_5.txt")
struct_acc_rt_block6 <- read.delim("Struct_acc_rt_dprime_Part2_BLOCK_6.txt")

#binding together all the blocks
struct_acc_dprime_rt_all_blocks <- rbind(struct_acc_rt_block1, struct_acc_rt_block2, struct_acc_rt_block3, struct_acc_rt_block4, struct_acc_rt_block5, struct_acc_rt_block6)
