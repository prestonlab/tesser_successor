 ...
 */
    __pyx_t_1 = __pyx_v_n;
    __pyx_v_s_new = (*((int *) ( /* dim=0 */ (__pyx_v_envstep.data + __pyx_t_1 * __pyx_v_envstep.strides[0]) )));
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_M.data + __pyx_t_13 * __pyx_v_M.strides[0]) ) + __pyx_t_14 * __pyx_v_M.strides[1]) )) = (((1.0 - __pyx_v_alpha) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_M.data + __pyx_t_1 * __pyx_v_M.strides[0]) ) + __pyx_t_8 * __pyx_v_M.strides[1]) )))) + (__pyx_v_alpha * ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_onehot.data + __pyx_t_9 * __pyx_v_onehot.strides[0]) ) + __pyx_t_10 * __pyx_v_onehot.strides[1]) ))) + (__pyx_v_gamma * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_M.data + __pyx_t_11 * __pyx_v_M.strides[0]) ) + __pyx_t_12 * __pyx_v_M.strides[1]) )))))));
    }
